"use client"
import appScreen from "../assets/images/bik.png";
...
export const ProductShowcase = () => {
  ...
  return (
    <div className="bg-white text-black bg-gradient-to-b from-white to-[#A39CE0] py-[72px] sm:py-24">
      <div className="container">
        <h2 className="text-center text-5xl font-bold tracking-tighter">Intuitive interface</h2>
        <div className="max-w-xl mx-auto">
          <p className="text-xl text-black/70 text-center mt-5">
